...
import (
	models "chitests/internal/models"
	context "context"
	reflect "reflect"
...
func (m *MockUserRepository) FindUserByEmail(ctx context.Context, username string) (models.UserAccount, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) FindUserByEmail(ctx, username interface{}) *gomock.Call {
...
func (m *MockUserRepository) RegisterUser(ctx context.Context, u models.UserAccount) error {
	m.ctrl.T.Helper()
...
func (mr *MockCryptoPasswordMockRecorder) ComparePasswords(fromUser, fromDB interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockJWTManagerMockRecorder) IssueToken(userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
